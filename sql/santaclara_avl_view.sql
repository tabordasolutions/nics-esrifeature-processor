...
CREATE OR REPLACE VIEW Santaclara_avl AS
    ...
    to_char(to_timestamp( ((gpf.properties)::json ->> 'StatusTime')::numeric/1000), 'YYYY/MM/DD HH24:MI:SS') AS "StatusTime",
    ...
    to_char(to_timestamp(((gpf.properties)::json ->> 'LastUpdate')::numeric/1000), 'YYYY/MM/DD HH24:MI:SS') AS "LastUpdate",
